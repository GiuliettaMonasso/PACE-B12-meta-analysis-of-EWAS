infile<-"MA.b12.maternal.main.model.GSM.no.MARBLES.1.txt"
filepref<-"MA.b12.maternal.main.model.GSM.no.MARBLES"
...
# write.csv(selection, file = "MA.b12.maternal.main.model.GSM.1.zonderDf=0.cross.reactive.probes.csv", row.names = F, quote = F) 

# MA<-read.csv("MA.b12.maternal.main.model.GSM.1.zonderDf=0.cross.reactive.probes.csv", header = T, strings = F)
...
MA$P.value.FDR <- p.adjust(MA$P.value, method = "BH")
summary(MA)
outfile<- paste(filepref, ".csv", sep = "")
